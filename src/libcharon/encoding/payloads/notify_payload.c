...
ENUM_NEXT(notify_type_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_RESPONSE",
	"RADIUS_ATTRIBUTE");
ENUM_NEXT(notify_type_names, FRAGMENT_ACK, SELECTIVE_FRAGMENT_RETRANSMISSION_SUPPORTED, RADIUS_ATTRIBUTE,
	"FRAGMENT_ACK",
	"SELECTIVE_FRAGMENT_RETRANSMISSION_SUPPORTED");
ENUM_END(notify_type_names, SELECTIVE_FRAGMENT_RETRANSMISSION_SUPPORTED);
...
ENUM_NEXT(notify_type_short_names, ME_MEDIATION, RADIUS_ATTRIBUTE, USE_BEET_MODE,
	...
	"ME_R",
	"RADIUS");
ENUM_NEXT(notify_type_short_names, FRAGMENT_ACK, SELECTIVE_FRAGMENT_RETRANSMISSION_SUPPORTED, RADIUS_ATTRIBUTE,
	"FRAG_ACK",
	"SEL_FRAG_RETRANS");
ENUM_END(notify_type_short_names, SELECTIVE_FRAGMENT_RETRANSMISSION_SUPPORTED);
