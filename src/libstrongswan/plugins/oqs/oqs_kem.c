...
oqs_kem_t *oqs_kem_create(key_exchange_method_t method)
{
	...
	switch (method)
	{
		...
		case CLASSIC_MCELIECE_348864:
			kem_alg = OQS_KEM_alg_classic_mceliece_348864;
			break;
		case CLASSIC_MCELIECE_348864F:
			kem_alg = OQS_KEM_alg_classic_mceliece_348864f;
			break;
		case CLASSIC_MCELIECE_460896:
			kem_alg = OQS_KEM_alg_classic_mceliece_460896;
			break;
		case CLASSIC_MCELIECE_460896F:
			kem_alg = OQS_KEM_alg_classic_mceliece_460896f;
			break;
		case CLASSIC_MCELIECE_6688128:
			kem_alg = OQS_KEM_alg_classic_mceliece_6688128;
			break;
		case CLASSIC_MCELIECE_6688128F:
			kem_alg = OQS_KEM_alg_classic_mceliece_6688128f;
			break;
		case CLASSIC_MCELIECE_6960119:
			kem_alg = OQS_KEM_alg_classic_mceliece_6960119;
			break;
		case CLASSIC_MCELIECE_6960119F:
			kem_alg = OQS_KEM_alg_classic_mceliece_6960119f;
			break;
		case CLASSIC_MCELIECE_8192128:
			kem_alg = OQS_KEM_alg_classic_mceliece_8192128;
			break;
		case CLASSIC_MCELIECE_8192128F:
			kem_alg = OQS_KEM_alg_classic_mceliece_8192128f;
			break;
		/* HQC */
		case HQC_128:
