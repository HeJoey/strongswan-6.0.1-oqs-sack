...
ENUM_NEXT(key_exchange_method_names, MODP_1024_160, ML_KEM_1024, ECP_521_BIT,
	...
	"ML_KEM_768",
	"ML_KEM_1024");
ENUM_NEXT(key_exchange_method_names, KYBER_512, FRODOKEM_1344_SHAKE, ML_KEM_1024,
	"KYBER_512",
	"KYBER_768",
	"KYBER_1024",
	"BIKE_L1",
	...
	"FRODOKEM_1344_AES",
	"FRODOKEM_1344_SHAKE");
ENUM_NEXT(key_exchange_method_names, MODP_NULL, MODP_NULL, FRODOKEM_1344_SHAKE,
	"MODP_NULL");
...
ENUM_NEXT(key_exchange_method_names_short, MODP_1024_160, ML_KEM_1024, ECP_521_BIT,
	...
	"mlkem768",
	"mlkem1024");
ENUM_NEXT(key_exchange_method_names_short, KYBER_512, FRODOKEM_1344_SHAKE, ML_KEM_1024,
	"kyber512",
	"kyber768",
	"kyber1024",
	"bikel1",
	...
	"frodokem1344aes",
	"frodokem1344shake");
ENUM_NEXT(key_exchange_method_names_short, MODP_NULL, MODP_NULL, FRODOKEM_1344_SHAKE,
	"modpnull");
